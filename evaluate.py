...
if __name__ == '__main__':
    ...
    ids = [
        i.strip() for i in open(root_dir + 'ImageSets/Segmentation/val.txt')
        if not i.strip() == ''
    ]
    ...
    classes = np.array((
        ...
        'train',
        'tvmonitor'))
    colormap = [(0, 0, 0), (0.5, 0, 0), (0, 0.5, 0), (0.5, 0.5, 0), (0, 0, 0.5),
                (0.5, 0, 0.5), (0, 0.5, 0.5), (0.5, 0.5, 0.5), (0.25, 0, 0),
                (0.75, 0, 0), (0.25, 0.5, 0), (0.75, 0.5, 0), (0.25, 0, 0.5),
                (0.75, 0, 0.5), (0.25, 0.5, 0.5), (0.75, 0.5, 0.5), (0, 0.25, 0),
                (0.5, 0.25, 0), (0, 0.75, 0), (0.5, 0.75, 0), (0, 0.25, 0.5)]
    ...
    for ind, img_id in enumerate(ids):
        ...
        gt = np.array(
            gt,
            dtype=np.int32)  # shape = [h, w], 0-20 is classes, 255 is ingore boundary
